...
```
-- Method 1
SELECT EMPNO, ENAME, SAL, SAL * 365 AS ANNSAL FROM EMPY ORDER BY ANNSAL ASC;
-- Method 2
SELECT EMPNO, ENAME, SAL, (SAL * 12) AS ANNSAL FROM EMPY ORDER BY ANNSAL ASC;
```
...
```
-- Method 1
SELECT * FROM EMPY WHERE MGR = 7369;
-- Method 2
...
```
-- Method 1
SELECT *, SAL * 365 AS ANNUAL_SAL FROM EMPY WHERE SAL * 365 BETWEEN 220000 AND 450000;
-- Method 2
...
```
-- Method 1
SELECT ENAME FROM EMPY WHERE ENAME LIKE 'S__H';
-- Method 2
...
```
-- Method 1
SELECT ENAME FROM EMPY WHERE SAL LIKE '%0';
-- Method 2
